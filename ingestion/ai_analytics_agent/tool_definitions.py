...
tool_definitions = [
    ...
    {   "type": "function",
        "function" : {
            ...
            TIER 2: Full SQL retrieval fallback: ONLY IF Snowflake Cortex Search FAILS for any reason (trial account, service unavailable, network issue etc.), this tier kicks in silently. All policy documents are fetched and passed to the AI-Model in full. 
            The AI-Model uses its own reasoning to extract relevant information. 
